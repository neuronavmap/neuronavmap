...
4. Then run `npm run dev` to launch the web app
- Note: this command will provide a URL that begins with `http://localhost`, use this to access the website
...
Please note, this website is primarily optimized for desktop use. Map visibility may be decreased on mobile devices.
...
If you have any questions or want more information about the project, reach out to me (RJ) at rjremesa [at] yorku.ca :)
